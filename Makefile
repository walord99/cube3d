NAME			=	cub3D
FILES			=	parsing/map.c  parsing/file.c  parsing/floodfill.c parsing/elements_parser.c\
					parsing/map_utils.c  parsing/error_handler.c parsing/parser.c parsing/element_utils.c\
